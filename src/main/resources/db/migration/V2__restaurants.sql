...
create table ProductsMenu (id bigserial, title varchar(255), description varchar(5000), category int, price int, restaurant_id int, primary key (id));
insert into ProductsMenu
(title, description, category, price, restaurant_id) values
('Светлое пиво', 'Свежее светлое пиво', 1, 320, 1),
('Темное пиво', 'Свежее темное пиво', 2, 350, 1),
('Гренки', 'Гренки с чесноком', 3, 80, 1),
('Гамбургер', 'Гамбургер с сыром', 1, 50, 2),
('Биг Тейсти', 'Большой гамбургер', 2, 160, 2),
('Кока-кола', 'Прохладительный напиток', 3, 50, 2),
('Свинина на гриле', 'Жареное мясо', 1, 150, 3),
('Жаренные овощи ', 'Запеченные овощи', 2, 100, 3),
('Салат цезарь', 'Салат', 3, 150, 3),
('Кофе', 'Стандартный кофе', 1, 70, 4),
('Американо', 'Большой кофе', 2, 100, 4),
('Капучино', 'Кофе с молоком', 3, 120, 4),
('Маргарита', 'Стандартная пицца', 1, 120, 5),
('Четыре сыра', 'Пицца с 4 видами сыра', 2, 170, 5),
('Перерони', 'Острая пицца', 3, 180, 5),
('Буррито', 'Жаренный буррито', 1, 150, 6),
('Куриные крылышки', 'Жаренная курица', 2, 120, 6),
('Картофель Фри', 'Жаренный картофель', 3, 100, 6);
